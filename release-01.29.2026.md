...
Healthcare Professionals can now upload their CV during onboarding to automatically extract and pre-fill key profile details, making profile setup faster and easier.

CV extraction is designed to assist, not replace, manual input. All extracted information must be reviewed and confirmed by the user before their profile is considered complete.
...
We’ve improved how Jobs and Shifts are surfaced to create a fairer, more balanced feed, ensuring urgent, underexposed, and newly posted opportunities all get the visibility they deserve.<br>
...
We’ve updated how job opening notifications are sent to reduce email overload and keep Healthcare Professionals better informed without spamming their inbox.
...
Healthcare Professionals can now upload and manage multiple site clearance documents, allowing them to be eligible for assignments across different client sites.
