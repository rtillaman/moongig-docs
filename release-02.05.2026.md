...
This update helps recruiters respond faster to active applicants and keeps the Jobs page focused on roles that are actively moving.
...
This approach maximizes exposure to new roles when volume is low, while maintaining relevance and readability during high-volume weeks.
